              ...
              <div className="w-full h-fit group">
                <div className="relative overflow-hidden">
                  <img
                    ...
                    alt={value.name}
                  />
                  <div className="absolute h-full w-full bg-dark-100/30 flex items-center justify-center -bottom-10 group-hover:bottom-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                    <button
                      className="bg-greySimple-100 bg-opacity-30 text-whiteSimple-100 py-2 px-5"
                      type="button"
                    >
                      Plus de détails
                    </button>
