...
So we decided to take this idea and adapt it as a Single Page Application.
</p>
<p>  
This application meets a specific need in our company (SNCF). 
<br/> To know: the  <strong>rapid search</strong> for a training room available even for a very short time (from 15 minutes to several hours).</p>
...
User management, their registration to the modification of their account. and so many other things.</p>
...
<h3><ins>To start the project :</ins></h3>
  ...
  <ol>
<li>
 cd Projet GD_Salles/backend</li>
<li>``npm install``</li>
